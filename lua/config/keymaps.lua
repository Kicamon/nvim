local nmappings  = {
  ...
  { mode = { 'n', 'v' }, lhs = 'H',                rhs = '0',                                     opts = { noremap = true } },
  ...
  { mode = { 'n' },      lhs = 'sh',               rhs = '<cmd>set nosplitright<CR>:vsplit<CR>',  opts = { noremap = true } },
  { mode = { 'n' },      lhs = 'sj',               rhs = '<cmd>set splitbelow<CR>:split<CR>',     opts = { noremap = true } },
  { mode = { 'n' },      lhs = 'sk',               rhs = '<cmd>set nosplitbelow<CR>:split<CR>',   opts = { noremap = true } },
  { mode = { 'n' },      lhs = 'sl',               rhs = '<cmd>set splitright<CR>:vsplit<CR>',    opts = { noremap = true } },
  { mode = { 'n' },      lhs = 'smv',              rhs = '<C-w>t<c-W>H',                          opts = { noremap = true } },
  { mode = { 'n' },      lhs = 'smh',              rhs = '<C-w>t<c-W>K',                          opts = { noremap = true } },
...
local MdSnippets = {
  { lhs = '<Tab><Tab>',    rhs = '<Esc>/<++><CR>:nohlsearch<CR>"_c4l' },
  { lhs = '<Tab><leader>', rhs = '<Tab>' },
  { lhs = '《',            rhs = '《》<Esc>i' },
  { lhs = '》',            rhs = '> ' },
  { lhs = '（',            rhs = '（）<Esc>i' },
  { lhs = '“',             rhs = '“”<Esc>i' },
